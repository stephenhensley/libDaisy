...
class AudioHandle
{
  public:
    ...
    */
    ...
    /** Immediately clear the callback back to a nullptr
     *  This will continue internal DMA IRQs, but will no longer
     *  perform internal callbacks within the audio engine.
     */
    Result ClearCallback();
